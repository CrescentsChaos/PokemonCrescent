...
class Moves:
    def __init__(self):
        ...
        self.protectmoves=["Max Guard","Protect","King's Shield","Spiky Shield","Baneful Bunker","Silk Trap","Obstruct","Burning Bulwark"]
