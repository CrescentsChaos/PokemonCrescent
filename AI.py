...
async def moveAI(x, y, tr1, tr2, field):
    ...
    for my_type in my_types:
        if my_type in TYPE_MOVES:
            mystablist.update(set(mymove) & set(TYPE_MOVES[my_type]))
    ...
    use = None
    superduper = list(emove & mystablist)
    ...
    if use is None:
        ...
        elif list(all_moves & mystablist):
            use = random.choice(list(all_moves & mystablist))
